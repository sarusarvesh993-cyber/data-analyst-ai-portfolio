...
def render_home_hero() -> None:
    st.markdown(
        ...
        <div class="home-hero">
            ...
            <p class="hero-copy">
                Explore seven interactive analytics workflows spanning retention,
                forecasting, experimentation, SQL, segmentation, financial planning, and
                healthcare operations—each with tested calculations and honest limitations.
            </p>
            <div class="hero-badges">
                ...
                <span class="hero-badge">29 automated tests</span>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
